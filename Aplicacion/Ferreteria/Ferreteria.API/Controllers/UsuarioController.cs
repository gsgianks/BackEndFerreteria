...
namespace Ferreteria.API.Controllers
{
    ...
    public class UsuarioController : ControllerBase
    {
        ...
        public IActionResult Post([FromBody] Usuario usuario)
        {
            ...
            usuario.Usuario_Creacion = JwtProvider.ObtenerUsuario(Request.Headers["Authorization"]);
        ...
        public IActionResult Put([FromBody] Usuario usuario)
        {
            ...
            usuario.Usuario_Modificacion = JwtProvider.ObtenerUsuario(Request.Headers["Authorization"]);
